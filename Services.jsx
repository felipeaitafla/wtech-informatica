...
const SERVICES = [
  {
    num: '01',
    title: 'Formatação',
    img: 'assets/portfolio/laptop-deep-clean.webp',
  ...
  },
  {
    ...
    img: 'assets/portfolio/laptop-screen-disassembly.webp',
  ...
  },
  {
    ...
    img: 'assets/portfolio/motherboard-thermal.webp',
  ...
  },
  {
    ...
    img: 'assets/portfolio/hp-laptop-internals.webp',
  ...
  },
  {
    ...
    img: 'assets/portfolio/pc-build-rtx.webp',
  ...
  },
  {
    ...
    img: 'assets/portfolio/aorus-ryzen-build.webp',
  ...
  },
  {
    ...
    img: 'assets/portfolio/dell-aio-board.webp',
  ...
  },
  {
    ...
    img: 'assets/portfolio/laptop-board-fan.webp',
  ...
  <section id="servicos" className="wt-section wt-section--alt" data-screen-label="Services">
    <div className="wt-container">
      <header className="wt-section__head wt-section__head--center">
        ...
        <p>
          Diagnóstico antes de qualquer reparo, orçamento aprovado por você.
        </p>
      </header>
          ...
          <article key={s.num} className="wt-service-card">
            ...
            <div className="wt-service-card__body">
              ...
              <a
                ...
                href={`https://wa.me/5562993291737?text=${encodeURIComponent(`Olá! Gostaria de saber mais sobre ${s.title}.`)}`}
                target="_blank"
